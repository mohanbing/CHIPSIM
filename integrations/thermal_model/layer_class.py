...
class Layer_chiplet:
    ...
    def plot_heatmap(self, temperature_all_layer, utils):
        ...
        plt.colorbar(sm, ax=ax).set_label('Temperature (C)', fontweight='bold')

        plt.gca().set_aspect('equal', adjustable='box')
        plt.title(self.layer_name + ' Heatmap')
        # bold the xlabel and ylabel
        # make the tikcs bold
        plt.xlabel('Horizontal Position (mm)', fontweight='bold')
        plt.ylabel('Vertical Position (mm)', fontweight='bold')
